	...
	return (
		<div id='Event-View'>
			<div id='Container_Event_Header'>
				<div id='Holder_Wallpaper_Event'></div>
				<div id='Holder_DateButton_Event'>
					<div id='Holder_Date_Event'>
						<h3>
							{event.date
								? new Date(event.date.start).getDate()
								: '...'}
						</h3>
						<p>
							{event.date
								? month[new Date(event.date.start).getMonth()]
								: '...'}
						</p>
					</div>
				...
				<div id='Holder_Title_Event'>
					<h5 id='Date_Event'>
						{event.date
							? new Date(event.date.start).toDateString() +
							  ' ' +
							  new Date(event.date.start).toTimeString()
							: '...'}
					</h5>
			...
			<div id='Container_Event_Details'>
				<div class='Wrapper_Left_Event_Details'>
					...
					<div id='Wrapper_Container'>
						<div class='Container_Host Container_EventDetails'>
							...
							>
								<Card
									title='Dianne Chrystalin Brandez'
									role='Host'
								/>
								<Card
									title='Dianne Chrystalin Brandez'
						...
						<div>
							<div
								id='Participants'
								class='Container_Analytics Container_EventDetails'
							>
								<h4>Participants</h4>
				...
				<div className='Wrapper_Right_Event_Details'>
					{EventCeritifcate ? (
						<>
							<div
								className='Container_EventDetails'
								id='Holder_Certificate_Event_Details'
							>
								<h4>Certificate</h4>
