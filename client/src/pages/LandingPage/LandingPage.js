                  ...
                  <div id="Holder_FAQ_Section">
                    <ul>
                      <li className={(openTab === "FAQ1")? "active":""} onClick={()=> (openTab === "FAQ1")? setopenTab("") :  setopenTab("FAQ1")}>
                        <h4>Title</h4>
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310.34 466.48"><defs><style></style></defs><path className="cls-1" d="M223.33,482.24a50,50,0,0,1-32.94-87.63l165.48-144.8L188.54,103.39a50,50,0,1,1,65.85-75.26L464.73,212.18a50,50,0,0,1,0,75.26L256.24,469.87A49.8,49.8,0,0,1,223.33,482.24Z" transform="translate(-171.46 -15.76)"/></svg>
